"items_game"
{
	...
	"items"
	{
		...
		"306"
		{
			...
			"show_in_armory"	"1"
			"item_type_name" "#TF_Wearable_Hat"
			"item_name"	"#TF_ScotchBonnet"
			"item_description"	"#TF_ScotchBonnet_Desc"
			"item_slot"	"head"
			"item_quality"	"unique"
			"image_inventory"	"backpack/player/items/demo/demo_scotchbonnet"
			"image_inventory_size_w"		"128"
			"image_inventory_size_h"		"82"
			"model_player"	"models/player/items/demo/demo_scotchbonnet.mdl"
			"drop_type"	"drop"
			"propername"	"0"
			"used_by_classes"
			{
