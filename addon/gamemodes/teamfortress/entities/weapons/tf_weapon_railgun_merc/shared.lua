...
SWEP.PrintName			= "Mercenary Railgun"
SWEP.Slot				= 5
...
SWEP.ViewModel			= "models/weapons/v_models/v_railgun_mercenary.mdl"
SWEP.WorldModel			= "models/weapons/w_models/w_railgun.mdl"
...
SWEP.ShootSound = Sound("Weapon_ShootingStar.Single")
SWEP.ShootCritSound = Sound("Weapon_ShootingStar.SingleCharged")
