...
SWEP.ShootSound = Sound("weapons/grenade_launcher_dm_shoot.wav")
SWEP.ShootCritSound = Sound("weapons/grenade_launcher_dm_shoot_crit.wav")
SWEP.ReloadSound = Sound("weapons/grenade_launcher_dm_drum_load.wav")
...
function SWEP:ShootProjectile()
	if SERVER then
		...
		grenade.ExplosionSound = "Weapon_QuakeRPG.Explode"
