...
SWEP.ReloadSound = Sound("weapons/asscannon_reload.wav")
SWEP.EmptySound = Sound("Weapon_Minigun.ClipEmpty")
SWEP.ShootSound2 = Sound("weapons/asscannon_shoot.wav")
SWEP.SpecialSound1 = Sound("weapons/asscannon_wind_up.wav")
SWEP.SpecialSound2 = Sound("weapons/asscannon_wind_down.wav")
SWEP.SpecialSound3 = Sound("weapons/asscannon_spin.wav")
SWEP.ShootCritSound = Sound("weapons/asscannon_shoot_crit.wav")
...
function SWEP:CanPrimaryAttack()
	if self.Owner:GetAmmoCount(self.Primary.Ammo) <= 0 then
		...
		self:EmitSound("weapons/shotgun_cock_forward.wav", 80, 100)
