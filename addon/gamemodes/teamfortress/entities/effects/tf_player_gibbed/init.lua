...
local GenericGibs = {Gibs={
	[GIB_LEFTLEG]		= GIBS_LAST,
	[GIB_RIGHTLEG]		= GIBS_LAST+1,
	[GIB_LEFTARM]		= GIBS_LAST+2,
	[GIB_RIGHTARM]		= GIBS_LAST+3,
	[GIB_TORSO]			= GIBS_LAST+4,
	[GIB_TORSO2]		= GIBS_LAST+5,
	[GIB_HEAD]			= GIBS_LAST+6,
	[GIB_HEADGEAR1]		= GIBS_LAST+7,
	[GIB_HEADGEAR2]		= GIBS_LAST+8,
	[GIB_ORGAN]			= GIBS_LAST+9,
}}
